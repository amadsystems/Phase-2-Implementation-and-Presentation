...
-- Some example queries to show that our basketball league database works.

-- TRIGGER:
-- This checks if the game date is actually inside the season.
...
-- READ 1: players and their guardians
SELECT p."first_name", p."last_name", g."first_name", g."last_name", g."email"
FROM "Player" p
JOIN "Guardian" g ON p."guardian_id" = g."guardian_id";
...
SELECT p."first_name", p."last_name", t."team_name", rs."status_name"
FROM "Registration" r
...
-- READ 4: game schedule and scores
SELECT g."game_id", h."team_name" AS "home_team", a."team_name" AS "away_team",
       g."game_date", g."game_time", g."home_score", g."away_score"
FROM "Game" g
JOIN "Team" h ON g."home_team_id" = h."team_id"
JOIN "Team" a ON g."away_team_id" = a."team_id";


-- READ 5: payments with player names
SELECT pay."payment_id", p."first_name", p."last_name", pay."amount", ps."status_name"
FROM "Payment" pay
...
-- READ 6: referees for each game
SELECT gr."game_id", ref."first_name", ref."last_name", ref."certification_level"
FROM "GameReferee" gr
...
-- UPDATE 5: update a guardian phone number
UPDATE "Guardian"
SET "phone" = '714-555-0999'
WHERE "guardian_id" = 1;


-- UPDATE 6: update a referee level
UPDATE "Referee"
...
INSERT INTO "Payment" ("registration_id", "amount", "payment_date", "status_id")
VALUES (1, 25.00, '2026-03-01', 1);

DELETE FROM "Payment"
WHERE "registration_id" = 1 AND "amount" = 25.00;


-- DELETE 4: add and delete a test referee
INSERT INTO "Referee" ("first_name", "last_name", "email", "certification_level")
VALUES ('Test', 'Referee', 'test.referee@gmail.com', 'Level 1');

DELETE FROM "Referee"
WHERE "email" = 'test.referee@gmail.com';


-- DELETE 5: add and delete a test gym
INSERT INTO "Gym" ("gym_name", "address", "city", "capacity")
VALUES ('Test Gym', '999 Test Ave', 'Fullerton', 100);

DELETE FROM "Gym"
WHERE "gym_name" = 'Test Gym';


-- DELETE 6: add and delete a test guardian
INSERT INTO "Guardian" ("first_name", "last_name", "email", "phone")
VALUES ('Test', 'Guardian', 'test.guardian@gmail.com', '714-555-0000');
